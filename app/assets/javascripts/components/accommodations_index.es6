            ...
            <div className="row">
              ...
              <div className="medium-4 columns">
                <ul>
                  ...
                  <li><a href="http://chicago.cubs.mlb.com/schedule/?c_id=chc#y=2016&m=8&calendar=DEFAULT" target="_blank">Chicago Cubs Game</a></li>
                  <li><a href="http://chicago.whitesox.mlb.com/schedule/index.jsp?c_id=cws#y=2016&m=8&calendar=DEFAULT" target="_blank">Chicago White Sox Game</a></li>
                </ul>

                <ul>
                  <h5>Zoos</h5>
                  <li><a href="http://www.lpzoo.org/" target="_blank">Lincoln Park Zoo</a></li>
                  <li><a href="https://www.czs.org/Brookfield-ZOO/Home" target="_blank">Brookfield Zoo</a></li>
                </ul>

                <ul>
                  <h5>Misc.</h5>
                  <li><a href="http://www.riverscasino.com/desplaines/#sm.000011797i23htfhawkhzwbaqrn5z" target="_blank">Rivers Casino</a></li>
                </ul>
              </div>
            </div>
          </div>
